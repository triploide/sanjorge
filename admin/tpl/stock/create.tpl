                    ...
                    >
                        ...
                        <div role="content">
                            ...
                            <div class="widget-body">
                                ...
                                <table id="stock" class="table table-striped table-bordered table-hover smart-form" width="100%" style="margin-bottom: 20px">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <label class="input"><input class="stock" name="cantidad" type="text" value="" data-type="int" /></label>
                                ...
                                <footer>
                                    <form id="formStock" action="php/controllers/stock.controller.php" method="post" style="display: inline-block;">
